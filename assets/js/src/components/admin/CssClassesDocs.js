    ...
    return (
        <div className="wrap mayo-docs">
            ...
            <div className="card">
                ...
                <p>This documentation explains the dynamic CSS classes used in the Event Card component. These classes are generated based on event properties and can be used to style specific events.</p>
                ...
                <div className="mayo-tab-content">
                    ...
                    <pre><code>{`
/* Style events with the "meetings" category */
.mayo-event-category-meetings {
    border-left: 4px solid #4a90e2;
}

/* Style events with the "workshops" category */
.mayo-event-category-workshops {
    border-left: 4px solid #e2844a;
}

/* Style service events */
.mayo-event-type-service {
    background-color: #f0f7ff;
}

/* Style events from a specific service body */

const ApiDocs = () => {
    ...
    return (
        <div className="wrap mayo-docs">
            ...
            <div className="card">
                <h2>Overview</h2>
                <p>The Mayo Events Manager provides a REST API for programmatic access to events. All endpoints use the namespace <code>event-manager/v1</code>.</p>
...
# Get settings
curl "${baseUrl}/wp-json/event-manager/v1/settings"`}</code></pre>
            </div>
        </div>
    );
};
